...
public class DrawingPanel extends FileFilter
    implements ActionListener, MouseListener, MouseMotionListener, Runnable, WindowListener, KeyListener {
    ...
    private static final String TITLE              = "GAMING panel";
    ...
    private static final int DELAY                 = 30;     // delay between repaints in millis
